...
for(yy in FY:(FY+end_fy)){
	...
	#
		...
		fst::write_fst(x = joined_table, path = file.path(getOption("maps.discardsPath"), paste0('discard_est_', species_itis, '_scal_trips_SCAL', yy,'.fst')))

		t2 = Sys.time()

		# TODO: change print to logr
