...
# 	write.csv('groundfish_loop_results_gftrips_only_020722.csv', row.names = F)
...
db_drop_table(bcon, 'CAMS_DISCARD_EXAMPLE_GF19')
...
dbSendQuery(ccon, statement = "DROP TABLE CAMS_GARFO.CAMS_DISCARD_EXAMPLE_GF19")

dbSendQuery(ccon, statement = "CREATE TABLE CAMS_GARFO.CAMS_DISCARD_EXAMPLE_GF19 as select * from MAPS.CAMS_DISCARD_EXAMPLE_GF19", overwrite = T)
