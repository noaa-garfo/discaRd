...
trans_rate_df = trans_rate_df %>% 
 ...
 saveRDS(joined_table, file = paste0('OUTPUT/discard_est_', species_itis, '_non_gftrips.RDS'))
...
res_cams_gear = allgf %>%
	...
	# write.csv('groundfish_loop_results_gftrips_only_020922.csv', row.names = F)
# View()
