...
5. Scallop trip estiamtes using Scallop Strata. This is complete (see item 2) but waiting on a correction in landings dealing with a buffer period between calendar years. 	

6. Add CV estiamate routine for Assumed strata; Already added this for Broad Stock Rate trips
