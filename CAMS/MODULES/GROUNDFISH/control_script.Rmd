...
# species = species[7,] #species[c(7,10),]
...
parse_upload_discard(bcon, filepath = '~/PROJECTS/discaRd/CAMS/MODULES/GROUNDFISH/OUTPUT/', FY = FY)
...
# make the tables from MAPS
  for(i in 1:nrow(tab_list)){
  	if(DBI::dbExistsTable(ccon, tab_list$OBJECT_NAME[i])) next
