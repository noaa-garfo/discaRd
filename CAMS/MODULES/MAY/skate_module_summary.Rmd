...
```sql
	MAPS.CAMS_DISCARD_BARNDOORSKATE_19
	CAMS_GARFO.CAMS_DISCARD_BARNDOORSKATE_19
	
	MAPS.CAMS_DISCARD_CLEARNOSESKATE_19
	CAMS_GARFO.CAMS_DISCARD_CLEARNOSESKATE_19
	
	MAPS.CAMS_DISCARD_LITTLESKATE_19
	CAMS_GARFO.CAMS_DISCARD_LITTLESKATE_19
	
	MAPS.CAMS_DISCARD_ROSETTESKATE_19
	CAMS_GARFO.CAMS_DISCARD_ROSETTESKATE_19
	
	MAPS.CAMS_DISCARD_SMOOTHSKATE_19
	CAMS_GARFO.CAMS_DISCARD_SMOOTHSKATE_19
	
	MAPS.CAMS_DISCARD_WINTERSKATE_19
	CAMS_GARFO.CAMS_DISCARD_WINTERSKATE_19
...
db_barndoorskate = tbl(bcon, sql("select * from MAPS.CAMS_DISCARD_BARNDOORSKATE_19")) %>% 
	collect

db_barndoorskate$SPECIES <- "BARNDOORSKATE"

db_clearnoseskate = tbl(bcon, sql("select * from MAPS.CAMS_DISCARD_CLEARNOSESKATE_19")) %>% 
	collect

db_clearnoseskate$SPECIES <- "CLEARNOSESKATE"

db_littleskate= tbl(bcon, sql("select * from MAPS.CAMS_DISCARD_LITTLESKATE_19")) %>% 
	collect

db_littleskate$SPECIES <- "LITTLESKATE"

db_rosetteskate = tbl(bcon, sql("select * from MAPS.CAMS_DISCARD_ROSETTESKATE_19")) %>% 
	collect

db_rosetteskate$SPECIES <- "ROSETTESKATE"

db_smoothskate = tbl(bcon, sql("select * from MAPS.CAMS_DISCARD_SMOOTHSKATE_19")) %>%
	collect

db_smoothskate$SPECIES <- "SMOOTHSKATE"

db_winterskate = tbl(bcon, sql("select * from MAPS.CAMS_DISCARD_WINTERSKATE_19")) %>%
	collect
