...
# species_nespp3 = c('012','352')
 
 species_nespp3 = c('364', '365', #skate
                    '366', '367', #skate
                    '368','369', #skate
                    '370', '372', #skate
                    '373','365') #skate
 ...
 # species <- species %>% filter(ITIS_TSN %in% c(564139,160855,564130,
 #                                           564136,564151,564149,
 #                                           564145))
...
db_drop_table(con = bcon, table = 'MAPS.CAMS_DISCARD_EXAMPLE_CY_ROSETTESKATE_19', force = F)

dbWriteTable(bcon, name = 'CAMS_DISCARD_EXAMPLE_CY_ROSETTESKATE_19', value = cy_discard_example, overwrite = T)
