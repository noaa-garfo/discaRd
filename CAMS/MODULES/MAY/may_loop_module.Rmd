...
db_drop_table(con = bcon, table = 'MAPS.CAMS_DISCARD_EXAMPLE_CY_X_19', force = F)

dbWriteTable(bcon, name = 'CAMS_DISCARD_EXAMPLE_CY_X_19', value = cy_discard_example, overwrite = T)
