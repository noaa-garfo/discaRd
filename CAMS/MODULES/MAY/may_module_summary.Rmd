...
Exploration of discard estimates from may year module developed for QM species
...
1. Discard estimates look comparable for CAMS and DMIS for 2019.
...
2. Need to add haddock catchcap (Atlantic herring).

3. Need to add skate complex and hakes. 
