---
title: "November loop module for discards"
output:
  pdf_document: 
    highlight: zenburn
    toc: yes
...
#--------------------------------------------------------------------------#
 ...
 species_nespp3 = c('446')  # Calendar year
...
db_drop_table(con = bcon, table = 'MAPS.CAMS_DISCARD_EXAMPLE_CY_TILEFISH_19', force = F)

dbWriteTable(bcon, name = 'CAMS_DISCARD_EXAMPLE_CY_TILEFISH_19', value = cy_discard_example, overwrite = T)
