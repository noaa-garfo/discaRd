...
Exploration of discard estimates from november year module developed for Tilefish.
...
```sql
	MAPS.CAMS_DISCARD_EXAMPLE_CY_TILEFISH_19
	CAMS_GARFO.CAMS_DISCARD_EXAMPLE_CY_TILEFISH_19
...
1. Discard estimates are a little bit lower for DMIS vs. CAMS for 2019.


### Current Issues with May Year Module
...
### Next Steps for May Year Module

1. Need to make sure I am including relevant QM nuances in calculation of discards for QM species. 

2. Deeper dive into results (e.g., compare DMIS and CAMS rates by strata)

3. Add summary to CAMS documentation once complete.
