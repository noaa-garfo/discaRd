...
CAMS_GEAR_STRATA <- read.csv("~/discaRd/CAMS/MODULES/CALENDAR/BSB_CAMS_GEAR_GROUP.csv")
...
CAMS_DISCARD_MORTALITY_STOCK <- read.csv("~/discaRd/CAMS/MODULES/CALENDAR/BSB_CAMS_DISCARD_MORTALITY_STOCK.csv")
