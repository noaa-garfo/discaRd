...
db_chubmackerel = tbl(bcon, sql("select * from MAPS.CAMS_DISCARD_MACKERELCHUB_2019")) %>%
	collect
...
db_surfclam = tbl(bcon, sql("select * from MAPS.CAMS_DISCARD_SURFCLAM_2019")) %>%
	collect

db_surfclam$SPECIES <- "SURFCLAM"

db_oceanquahog = tbl(bcon, sql("select * from MAPS.CAMS_DISCARD_OCEANQUAHOG_2019")) %>%
	collect
...
db_amshad = tbl(bcon, sql("select * from MAPS.CAMS_DISCARD_AMSHAD_2019")) %>%
	collect

db_amshad$SPECIES <- "AMSHAD"
...
db_final <- rbind(db_blackseabass, db_bluefish, db_butterfish, db_longfinsquid, 
            ...
            db_surfclam, db_oceanquahog, db_alewife, db_amshad)
