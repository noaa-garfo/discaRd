...
8. Rates and `DISCARD_SOURCE` (in parentheses) are assigned for each trip according to:
 ...
 - (B) Broad stock/gear rate <5 trips in season and <5 trips in previous season 
...
9. CV calculations are available for (I), (T), (A) and (B). 
...
db_final <- rbind(db_blackseabass, db_bluefish, db_butterfish, db_longfinsquid, 
                  db_shortfinsquid, db_mackerel, db_fluke)
