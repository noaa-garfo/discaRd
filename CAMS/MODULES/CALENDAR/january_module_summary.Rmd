...
1. Discard estimates look comparable for CAMS and DMIS for 2019.  Some species are really close (e.g., Mackerel and shortfin squid) and others the differences between CAMS and DMIS are larger (e.g., Butterfish).


### Current Issues with Calendar Year Module

1. KALL differences between DMIS and CAMS (mostly clams?)
...
### Next Steps for Calendar Year Module

1. Need to make sure I am including relevant QM nuances in calculation of 
   discards for QM species. For example, I've noticed that with SMB QM 2019 there are    business rules to give strata rates that don't have a final rate. 

2. Need to add herring/shad catchcap (Atlantic herring and mackerel trips), haddock     catchcap (Atlantic herring trips) and additional SBRM species.

3. Deeper dive into results (e.g., compare DMIS and CAMS rates by strata)
