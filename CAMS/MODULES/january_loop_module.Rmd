...
#Not sure what else is needed for herring and shad catch cap.
 ...
 species$ITIS_TSN <- str_sort(itis)
...
#	STRATA_USED,
 ...
 cy_discard_example <- cy_discard_example %>% case_when(CV = 'Inf' ~ 'NA')
...
dbWriteTable(bcon, name = 'CAMS_DISCARD_EXAMPLE_CY_FLUKE_19', value = cy_discard_example, overwrite = T)
