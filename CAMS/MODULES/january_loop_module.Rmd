...
#Not sure what else is needed for herring and shad catch cap.
 ...
 species_nespp3 = c('801','802','051', '170',
                    '023', '121', '335', '329')  # Calendar year
 
 # species_nespp3 = c('418')
...
species_itis <- as.character(species$SRCE_ITIS_TSN[i])
species_itis_srce = as.character(as.numeric(species$SRCE_ITIS_TSN[i]))
#--------------------------------------------------------------------------#
...
trans_rate_df = dest_strata_f %>% 
 ...
 final_table$COMMON_NAME <- species$ITIS_NAME[i]
...
db_drop_table(con = bcon, table = 'MAPS.CAMS_DISCARD_EXAMPLE_CY_BUTTERFISH_19', force = F)

dbWriteTable(bcon, name = 'CAMS_DISCARD_EXAMPLE_CY_BUTTERFISH_19', value = cy_discard_example, overwrite = T)
