...
- **OUTPUT TABLE:** CAMS_GARFO.GF_EM_DELTA_VTR_DISCARD
- **YEARS:** 2021+
...
```{r table_flow0, echo=F,fig.height=3,fig.width=8, fig.cap="Figure 1.   MAPS.GF_EM_DELTA_VTR_DISCARD table lineage"}
DiagrammeR::mermaid("
  graph LR
nemis.NEMIS_TRIP_MV --> MAPS.GF_EM_DELTA_VTR_DISCARD
nemis.NEMIS_HAUL_MV --> MAPS.GF_EM_DELTA_VTR_DISCARD
nemis.NEMIS_CATCH_MV --> MAPS.GF_EM_DELTA_VTR_DISCARD
noaa.document --> MAPS.GF_EM_DELTA_VTR_DISCARD
noaa.images --> MAPS.GF_EM_DELTA_VTR_DISCARD
        ")
```
