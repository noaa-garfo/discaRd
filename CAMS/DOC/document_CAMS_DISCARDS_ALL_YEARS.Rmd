...
## Data Sources
MAPS.CAMS_OBS_CATCH
MAPS.GF_EM_DISCARDS_ARCH
MAPS.GF_EM_DELTA_VTR_DISCARDS
MAPS.CAMS_DISCARD_MORTALITY_STOCK
MAPS.CAMS_OBS_CATCH
MAPS.CAMS_GEARCODE_STRATA
MAPS.CAMS_STATAREA_STOCK

```{r table_flow_1, echo=F,fig.height=3,fig.width=8, fig.cap="Figure 1.   CAMS_GARFO.CAMS_DISCARD_ALL_YEARS table lineage for GF species"}
DiagrammeR::mermaid("
  graph LR
  MAPS.CAMS_OBS_CATCH --> GF_Discard_Module
  MAPS.CAMS_DISCARD_MORTALITY_STOCK --> GF_Discard_Module
  MAPS.CAMS_GEARCODE_STRATA --> GF_Discard_Module
  MAPS.CAMS_STATAREA_STOCK --> GF_Discard_Module
  MAPS.CAMS_GF_EM_DISCARDS_ARCH --> GF_Discard_Module
  MAPS.CAMS_GF_EM_DELTA_VTR_DISCARDS --> GF_Discard_Module
  GF_Discard_Module --> CAMS_GARFO.CAMS_DISCARDS_ALL_YEARS
        ")
```
## Approach
GF module:
...
```{r table_flow_2, echo=F,fig.height=3,fig.width=8, fig.cap="Figure 2.   CAMS_GARFO.CAMS_DISCARD_ALL_YEARS table lineage"}
DiagrammeR::mermaid("
  graph LR
  MAPS.CAMS_OBS_CATCH --> Non_GF_Discard_Module
  MAPS.CAMS_DISCARD_MORTALITY_STOCK --> Non_GF_Discard_Module
  MAPS.CAMS_GEARCODE_STRATA --> Non_GF_Discard_Module
  MAPS.CAMS_STATAREA_STOCK --> Non_GF_Discard_Module
  Non_GF_Discard_Module --> CAMS_GARFO.CAMS_DISCARDS_ALL_YEARS
        ")
```
...
## Data Dictionary
```{r echo = F}
comments <- ROracle::dbGetQuery(bcon, "SELECT * FROM all_col_comments WHERE owner = 'MAPS' AND table_name = 'CAMS_DISCARD_MONKFISH_19'")
