...
digraph boxes_and_circles {
 ...
 node [shape = oval,
  ...
  node [shape = diamond,
        fixedsize = true,
        width = 2,  fontsize = 32, fontweight = 'bold'] // 
  'R';
...
- `run_discard`
	+ STRATA is assigned dynamically by species/stock using elements of the imported data
...
- Apply Discard Mortality 
	+ Match by CAMS_GEAR_GROUP at the subtrip level
...
- utilize discard mortality table (species/gear/mesh) **imminent..**
- decide on time periods **Determined by STOCK/SPECIES**
