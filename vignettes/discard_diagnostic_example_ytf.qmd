...
keyring::keyring_unlock(keyring = 'apsd', password = .rs.askForPassword(prompt = T))

con = apsdFuns::roracle_login(key_name = 'apsd', key_service = 'DB01P',schema = 'CAMS_GARFO',proxy = T, database_name = 'DB01P')

# get data ---- 
start_year = 2021
end_year = year(today())

dat = get_catch_obs_diag(con, start_year, end_year)
gf_dat = dat$gf_dat
